...
/**
 * A meadow under an open sky, behind everything.
 *
 * The one part that is not worn and not the doll, so it is the one part the
 * lateral margin does not apply to: a backdrop that stopped at the doll's
 * shoulders would be a poster she is standing next to. It fills the canvas.
 *
 * One colour still, like every other part. She picks the sky and the ground
 * follows it down a tone, which is what lets a green afternoon and a violet
 * evening both come out of the same drawing.
 */
